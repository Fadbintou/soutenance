<!-- <?php
// function insertion($nom,$prenom,$email,$tel,$date,$service,$message)
// {
//     if(require("cn.php"))
//     {
//         $req =  $bd->prepre("INSERT INTO rendez-vouz (nom,prenom,email,tel,dte,servi,msg) values($nom,$prenom,$email,$tel,$date,$service,$message)");

//         $req->execute(array($nom,$prenom,$email,$tel,$date,$service,$message));
...
//    $req->execute(array($nom,$prenom,$email,$tel,$date,$services,$message));
